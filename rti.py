...
സൂചനയിലേയ്ക്ക് ശ്രദ്ധ ക്ഷണിക്കുന്നു. സൂചന അപേക്ഷയില്‍ ആവശ്യപ്പെട്ട വിവരങ്ങള്‍
ഈ വകുപ്പിലെ പൊതു അധികാരിയുടെ പക്കല്‍ ലഭ്യമല്ല. ആയതിനാല്‍ ലഭ്യമായ വിവരങ്ങള്‍
താങ്കള്‍ക്ക്‌ നേരിട്ട്‌ നല്‍കുന്നതിനായി, വിവരാവകാശ നിയമത്തിലെ ചട്ടം 6(3) പ്രകാരം സൂചന
അപേക്ഷയുടെ പകര്‍പ്പ്, കെ.എസ്.ആര്‍.ടി.സി.യിലെ സ്റ്റേറ്റ്‌ പബ്ലിക്‌ ഇന്‍ഫര്‍മേഷന്‍ ഓഫീസര്‍ക്ക്‌
കൈമാറിയിട്ടുണ്ടെന്ന വിവരം അറിയിക്കുന്നു. ഇക്കാര്യത്തില്‍ തുടര്‍ കത്തിടപാടുകള്‍ മേല്‍ സൂചിപ്പിച്ച
സ്റ്റേറ്റ്‌ പബ്ലിക്‌ ഇന്‍ഫര്‍മേഷന്‍ ഓഫീസറുമായി നടത്തുവാന്‍ താല്‍പര്യപ്പെടുന്നു.
"""

FIXED_MALAYALAM_APPELLATE_INFO = """
മേല്‍ മറുപടിയില്‍ ആക്ഷേപമുള്ള പക്ഷം അപ്പീല്‍ കാലാവധിയായ 30 ദിവസത്തിനുള്ളില്‍
അപ്പീല്‍ അധികാരിക്ക് അപേക്ഷ സമര്‍പ്പിക്കാവുന്നതാണ്.

അപ്പീലധികാരി & അഡീഷണൽ സെക്രട്ടറി,
ഗതാഗത (എ) വകുപ്പ്, രണ്ടാം നില, അനക്സ് - 1 കെട്ടിടം,
ഗവ. സെക്രട്ടേറിയറ്റ്, തിരുവനന്തപുരം.
ഫോൺ : 0471 2518284.

സ്റ്റേറ്റ് പബ്ലിക് ഇൻഫർമേഷൻ ഓഫീസർ & അണ്ടർ സെക്രട്ടറി.
ഫോൺ നമ്പർ 0471 2518713
"""

FIXED_MALAYALAM_FOOTER_INFO = """
സ്റ്റേറ്റ് പബ്ലിക് ഇൻഫര്‍മേഷൻ ഓഫീസ‍‍ര്‍, മുഖ്യകാര്യാലയം,
കെ.എസ്.ആ‍ര്‍.ടി.സി., തിരുവനന്തപുരം. (
സൂചനയിലെ അപേക്ഷ സഹിതം വിവരാവകാശ നിയമം 2005 പ്രകാരം അപേക്ഷകന് നേരിട്ട് മറുപടി ലഭ്യമാക്കുന്നതിനായി).
"""
...
def generate_internal_note(malayalam_name, rti_num):
    subject = f"വിഷയം:- ഗതാഗത വകുപ്പ് - വിവരാവകാശ നിയമം, 2005 പ്രകാരം വിവരങ്ങള്‍ ലഭ്യമാക്കണമെന്ന് ആവശ്യപ്പെട്ടുകൊണ്ട് ശ്രീ./ശ്രീമതി {malayalam_name} സമർപ്പിച്ച അപേക്ഷ - സംബന്ധിച്ച്."
    body = f"""ശ്രീ./ശ്രീമതി {malayalam_name}, RTI-Portal മുഖേന സമർപ്പിച്ച {rti_num} നമ്പർ വിവരാവകാശ അപേക്ഷ ന.ഫ.‍ 1-3 പേജുകളിൽ സദയം കണ്ടാലും. ടി അപേക്ഷയിലെ ചോദ്യത്തിനുള്ള വിവരം ഈ വകുപ്പിലെ സ്റ്റേറ്റ് പബ്ലിക് ഇന്‍ഫര്‍മേഷന്‍ ഓഫീസറുടെ കൈവശമുളളവയല്ല. ആയതിനാൽ ലഭ്യമായ വിവരം അപേക്ഷകന് നേരിട്ട് നല്‍കുന്നതിനായി അപേക്ഷയുടെ പകർപ്പ്, വിവരാവകാശ നിയമത്തിലെ ചട്ടം 6(3) പ്രകാരം, KSRTC- യിലെ സ്റ്റേറ്റ് പബ്ലിക് ഇന്‍ഫര്‍മേഷന്‍ ഓഫീസര്‍ക്ക് കൈമാറാവുന്നതാണ്. 
...
def generate_reply_letter(orig_name, orig_address, rti_date, rti_num, lang):
    ...
    reference_line = f"താങ്കൾ RTI-Portal മുഖേന സമർപ്പിച്ച {rti_date}-ലെ {rti_num} നമ്പർ വിവരാവകാശ അപേക്ഷ."
...
with st.sidebar:
    ...
    if uploaded_file:
        ...
        st.markdown("---")
        st.error("**Disclaimer:Verify before submission**")
    else:
...
if uploaded_file and 'process_btn' in locals() and process_btn:
    with st.spinner("Extracting Data & Generating Drafts..."):
        ...
        if page_text:
            ...
            internal_note = generate_internal_note(mal_name, r_num)
